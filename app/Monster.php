...
class Monster extends GenericModel
{
	...
	{
		$this->logging->logJson($this->{self::ABILITIES});
	...
	private function validSkills(){
		return $this->setErrorOnFailed(self::SKILLS, function() {
			return (Validate::blackOrNull($this->{self::SKILLS})) ? true : $this->validateSkillsIfTheyExist();
		});
	}

	private function validateSkillsIfTheyExist(){
